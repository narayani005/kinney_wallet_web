    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="menu-title text-uppercase">My Profile</li>
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ url('/myprofile') }}">View Profile</a></li>
                                    <li><a href="{{ url('/edit_profile/'.auth()->user()->id) }}">Edit Profile</a></li>
                                </ul>
                            </li>
                            <li class="menu-title text-uppercase">My Wallet</li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="mdi mdi-email"></i>
                                    <span>My Wallet</span>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ url('/mywallet') }}">View & Share Wallet</a></li>
                                    <!--li><a href="{{ url('/share_wallet') }}">Share Profile</a></li-->
                                </ul>
                            </li>
                            @endif
                            @if(auth()->user()->is_admin)
                            ...
                            <li class="menu-title text-uppercase">Wallet</li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="mdi mdi-email"></i>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{ url('/wallet')}}">View Wallet</a></li>
                                    <li><a href="{{ url('/add_wallet')}}">Add Wallet</a></li>
                                </ul>
                            </li>
                            @endif
                            <!--li>
            ...
            <div class="main-content">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <div class="page-title">
                                        <h4 class="mb-0 font-size-18">Kinney Wallet Web</h4>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Homw</a></li>
                ...
                <footer class="footer">
                    © 2021 Kinney Wallet <span class="d-none d-sm-inline-block">- Crafted with <i
                            class="mdi mdi-heart text-danger"></i> by Kinney Infotech.</span>
                </footer>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <script>document.write(new Date().getFullYear())</script> © Kinney Wallet <span
                            class="d-none d-sm-inline-block">- Crafted with <i class="mdi mdi-heart text-primary"></i> by
                            Kinney Infotech.</span>
                    </div>
